  ...
  constructor(props) {
    ...
    this.state = {
      headers: [
        {
          id: 1,
          names: 'Contact Us', // Updated header name to "Contact Us"
        }
      ],
      titleheading: [
        {
          id: '1',
          title: 'Contact Us' // Updated page title to "Contact Us"
        }
      ],
      breadcrumbs: [
        {
        ...
        {
          id: 2,
          title: 'Contact Us', // Updated breadcrumb for "Contact Us" page
          classicon: '',
          aria: ''
        }
      ],
      contactinfo: [
        ...
        },
        {
          ...
          info: 'support@infitxhub.com' // Updated email address to the INFITX Empowerment Hub support email
        }
      ]
    }
  }
              ...
              <div className="row">
                <div className="col-md-12">
                  <div className="title-section center s1 pd-title-section">
                    ...
                    <p className="sub-title-section">Get in touch with us and empower yourself. We believe in providing financial opportunities that matter. Whether you have questions about our courses, microfinance options, or investment opportunities, our team is here to assist you. Let's work together to build a brighter financial future for women in Uganda.

<br />Contact us today and take the first step towards financial empowerment. Your journey to financial freedom starts here!</p>
                  </div>
          ...
          {/* Remove the flat-maps and gm-map sections as they seem unrelated to the content */}
